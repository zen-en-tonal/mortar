...
#   - Ex: docker.io/hexpm/elixir:1.19.5-erlang-28.3-debian-trixie-20260112-slim
#
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/mortar ./
